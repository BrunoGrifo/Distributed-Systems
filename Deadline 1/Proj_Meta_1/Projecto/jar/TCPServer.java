					...
					try {
						if (mesasVoto.size() != 0) {
							...
							if (option != 0) {
								...
								rmi.notifyAdmins("The table:" + mesaVoto.name + " was activaded");
							} else {
								System.exit(0);
							}
						} else {
...
class Connection extends Thread {
	...
	public Connection(int rmiPortBackUp, Socket aClientSocket, ArrayList<Connection> connections, String rmiHost,
			int rmiPort, int numero, Mesas mesaVoto, RMI rmi) {
		this.rmiPortBackUp = rmiPortBackUp;
