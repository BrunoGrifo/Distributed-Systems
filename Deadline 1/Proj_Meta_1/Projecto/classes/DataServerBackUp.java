...
public class DataServerBackUp extends UnicastRemoteObject implements RMI, java.io.Serializable {
	...
	public DataServerBackUp() throws RemoteException {
		super();
	}
	...
	public synchronized static void pings(int escolha) {
		if (escolha == 0) {
			...
			new UDPConnectionReceiveBackUp(rmiHost, rmiPort, rmiPortSec);
		} else {
			System.out.println("Tornou-se principal");
			new UDPConnectionSendBackUp(rmiHost, rmiPort, rmiPortSec);
		}
	}

	public synchronized static void load_config() throws RemoteException {
		read();
		String file = "DataServerConfigBackUp.txt";
		String line;
	...
	public synchronized String novo() {
		return "Olá senhor fabio";
	}

	public synchronized boolean update_server() {
		return true;
	}
	...
	public static void main(String args[]) throws RemoteException {
		...
		try {
			...
			DataServerBackUp dataserver = new DataServerBackUp();
...
class UDPConnectionReceiveBackUp extends Thread {
	DatagramSocket aSocket = null;
	public int port;
	public int portSec;
	public String host;

	public UDPConnectionReceiveBackUp(String host, int port, int portSec) {
		this.host = host;
		this.port = port;
	...
	public void run() {
		...
		try {
			...
			System.out.println("Socket Datagram à escuta novo");
			while (true) {
...
class UDPConnectionSendBackUp extends Thread {
	DatagramSocket aSocket = null;
	public int port;
	public int portSec;
	public String host;

	public UDPConnectionSendBackUp(String host, int port, int portSec) {
		this.host = host;
		this.port = port;
		this.portSec = portSec;
		this.start();
