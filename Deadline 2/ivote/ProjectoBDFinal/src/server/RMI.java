...
public interface RMI extends Remote {
	...
	// public void delete_table_from_faculty_and_department(String nome_mesa) throws
	// RemoteException;
	...
	/*
	 * 
	 * public Lista cria_listas(HashMap<String, ArrayList<Lista_candidata>> listas)
	 * throws java.rmi.RemoteException;
	 * 
	 * public void add_table(String name, Department department) throws
	 * java.rmi.RemoteException;
	 * 
	 * public void addNewElection(Eleicoes new_election) throws
	 * java.rmi.RemoteException;
	 * 
	 * public void add_pessoas(String name, String cargo, String password,
	 * Department departamento, Faculty chosen_faculty, int telefone, int numero_cc,
	 * Date validade_cc) throws java.rmi.RemoteException;
	 * 
	 ...
	 * 
	 * public String print_department_faculty(Faculty departs_print) throws
	 * java.rmi.RemoteException;
	 * 
	 ...
	 * 
	 * public ArrayList<Department> return_departments() throws
	 * java.rmi.RemoteException;
	 * 
	 * public ArrayList<Eleicoes> return_elections() throws
	 * java.rmi.RemoteException;
	 * 
	 * public String update_person(Pessoa update_person) throws
	 * java.rmi.RemoteException;
	 * 
	 * public String update_faculty(Faculty update_faculty) throws
	 * java.rmi.RemoteException;
	 * 
	 * public String update_election(Eleicoes update_election) throws
	 * java.rmi.RemoteException;
	 * 
	 * public String update_table(Mesas update_table) throws
	 * java.rmi.RemoteException;
	 * 
	 * public boolean getATerminal(int cc) throws RemoteException;
	 * 
	 * public String register_vote(String cc,String eleicao,String list, Mesas
	 * table) throws java.rmi.RemoteException;
	 * 
	 * public String print_elections_for_person(String cc, Mesas table) throws
	 * java.rmi.RemoteException;
	 * 
	 ...
	 * 
	 * 
	 * public void subscribe(Server_rmi mesa) throws RemoteException; public void
	 * subscribeAdmin(Admin_rmi_I admin) throws RemoteException; public boolean
	 * status(String cc) throws RemoteException; public boolean login(String
	 * username, String password) throws RemoteException; public ArrayList<Mesas>
	 * getMesasVoto() throws RemoteException;
	 */
