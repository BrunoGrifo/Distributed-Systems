...
<body>
		...
		<p>
		<c:forEach items="${heyBean.eleicaoTipo}" var="value">
			<c:out value="${value}" /><p>
		</c:forEach>

		<p>
		<c:forEach items="${heyBean.listaFaculdades}" var="value">
		<c:out value="${value}" /><p>
		</c:forEach>
		<p>
		<c:forEach items="${heyBean.listaDepartment}" var="value">
		<c:out value="${value}" /><p>
		</c:forEach>
		...
		<div class="form">
		<div id="mudar_tipo">
			<form action="mudar_tipo" method="post">
				...
				<div class="field-wrap">
					<label> new type(geral/department/faculty/nucleo)<span class="req">*</span>
					</label> <input type="text" name="novo_tipo" id="novo_tipo" required autocomplete="off" />
				</div>
				
				<div class="field-wrap">
					<label> department<span class="req">*</span>
					</label> <input type="text" name="department" id="department"/>
				</div>
				
				<div class="field-wrap">
					<label> faculty<span class="req">*</span>
					</label> <input type="text" name="faculty" id="faculty" />
				</div>
