...
<body>
	...
	<c:forEach items="${heyBean.cenasUser}" var="value">
		<c:out value="${value}" /><br>
	</c:forEach>
	
	<div class="form">
		<div id="escolher_eleicao">
			<form action="escolher_eleicao" method="post">

				<div class="field-wrap">
					<label> Id Eleicao <span class="req">*</span>
					</label> <input type="text" name="id_eleicao" id="id_eleicao" required
						autocomplete="off" />
				</div>
