...
<body>
		...
		<p>
		<c:forEach items="${heyBean.pessoasAdicionar}" var="value">
		<c:out value="${value}" /><p>
		</c:forEach>

		<div class="form">
		<div id="add_person_list">
			<form action="add_person_list" method="post">
				...
				<div class="field-wrap">
					<label> CC da pessoa<span class="req">*</span>
					</label> <input type="text" name="cc" id="cc" required autocomplete="off" />
				</div>

				<button class="button button-block">Associate</button>
			</form>
		</div>
	</div>
