...
<body>
		...
		<p>
		<c:forEach items="${heyBean.resumos}" var="value">
		<c:out value="${value}" /><p>
		</c:forEach>
		...
		<div class="form">
		<div id="mudar_resume">
			<form action="mudar_resume" method="post">
				...
				<div class="field-wrap">
					<label> new resume<span class="req">*</span>
					</label> <input type="text" name="resume" id="resume" required autocomplete="off" />
				</div>
