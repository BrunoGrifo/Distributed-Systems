...
<body>
		...
		<div class="form">
		<div id="mudar_inicio">
			<form action="mudar_inicio" method="post">
				...
				<div class="field-wrap">
					<label> Date formate(hh:mm:ss dd-mm-yyyy)<span class="req">*</span>
					</label> <input type="text" name="data_inicio" id="data_inicio" required autocomplete="off" />
				</div>
